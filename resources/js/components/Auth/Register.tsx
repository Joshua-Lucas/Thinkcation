        ...
        <div className="flex flex-col justify-center items-center m-auto my-20 rounded-lg shadow-xl w-11/12 bg-white md:w-3/4 lg:w-2/4 xl:w-2/6 2xl:w-1/5">
            ...
            >
                ...
                <input
                    ...
                    required
                />
                <p className="text-xs pt-1 w-5/6 font-thin text-lightaccent">
                    Make sure it matches your goverment ID
                </p>
                <input
                ...
                />
                {ofAge ? (
                    <p className="text-xs pt-1 w-5/6 mb-8 font-thin text-lightaccent">
                        To sign up, you need to be at least 18. Your birthday
                        won’t be shared with other people who use Thinkcation.
                    </p>
                ) : (
                ...
                <button
                    className="w-2/3 p-2 mt-8 rounded borader-2 bg-brand hover:bg-darkshade hover:text-lightshade lg:w-5/6"
                    type="submit"
                >
                    Signup
                </button>
